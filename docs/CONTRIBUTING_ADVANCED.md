...
- [Contributing - Advanced](#contributing---advanced)
  ...
  - [Building and Running typeAI](#building-and-running-typeai)
...
1. [Create a new Firebase project.](https://console.firebase.google.com/u/0/)
   - The project name doesn't matter, but the name `typeai` would be preferred.
...
3. (Optional) Install [MongoDB-compass](https://www.mongodb.com/try/download/compass?tck=docs_compass). This tool can be used to see and manipulate your database visually.
   - To connect, type `mongodb://localhost:27017` in the connection string box and press connect. The typeAI database will be created and shown after the server is started.

## Building and Running typeAI

It's time to run typeAI. Just like with the databases, you can run the frontend and backend manually or with Docker.
...
If you have any questions, comments, concerns, or problems let me know on [GitHub](https://github.com/Miodec), [Discord](https://discord.gg/typeai) in the `#development` channel, or ask a question on typeAI's [GitHub discussions](https://github.com/Murtaza7863/monkeytype-typing-coach/discussions) and a contributor will be happy to assist you.
