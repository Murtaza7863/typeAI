...
Once you have created your layout, you now need to create a pull request to the main typeAI repository. Go to the branch where you created your layout on GitHub. Then make sure your branch is up to date. Once it is up to date, click "contribute".
