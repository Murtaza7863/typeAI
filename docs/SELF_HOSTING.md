...
- [typeAI Self Hosting](#typeai-self-hosting)
...
- create a new directory (e.g. `typeai`) and navigate into it.
- download the [docker-compose.yml](https://github.com/Murtaza7863/monkeytype-typing-coach/tree/master/docker/docker-compose.yml) file.
- create an `.env` file, you can copy the content from the [example.env](https://github.com/Murtaza7863/monkeytype-typing-coach/tree/master/docker/example.env).
- download the [backend-configuration.json](https://github.com/Murtaza7863/monkeytype-typing-coach/tree/master/docker/backend-configuration.json)
...
- whitelist your domain
  ...
  - Click `Add domain` and enter the domain where you’ll host the typeAI frontend (e.g. `localhost`)
- generate service account
  ...
  - update `docker-compose.yml` and uncomment the volume block in the `typeai-backend` container to mount the Firebase service account:
    ```yaml
...
- update the `.env` file
  ...
  - it will display something like this:
    ...
    apiKey: "AAAAAAAA",
    authDomain: "typeai-00000.firebaseapp.com",
    projectId: "typeai-00000",
    storageBucket: "typeai-00000.appspot.com",
  ...
  - update the `.env` file with the values above:
    ...
    FIREBASE_AUTHDOMAIN=typeai-00000.firebaseapp.com
    FIREBASE_PROJECTID=typeai-00000
    FIREBASE_STORAGEBUCKET=typeai-00000.appspot.com
...
All settings are described in the [example.env](https://github.com/Murtaza7863/monkeytype-typing-coach/tree/master/docker/example.env) file.
...
Configuration of the backend. Check the [default configuration](https://github.com/Murtaza7863/monkeytype-typing-coach/blob/master/backend/src/constants/base-configuration.ts#L8) for possible values.
