...
export const GetTypingFeedbackResponseSchema =
  responseWithData(TypingFeedbackSchema);
export type GetTypingFeedbackResponse = z.infer<
  typeof GetTypingFeedbackResponseSchema
>;

export const GetTypingFeedbackQuerySchema = z.object({
  refresh: z.enum(["true", "false"]).optional(),
});
export type GetTypingFeedbackQuery = z.infer<
  typeof GetTypingFeedbackQuerySchema
>;
...
export const usersContract = c.router(
  {
    ...
    getTypingFeedback: {
      summary: "get AI typing feedback",
      description:
        "Personalized typing feedback based on recent test history (requires sufficient completed tests).",
      method: "GET",
      path: "/typingFeedback",
      query: GetTypingFeedbackQuerySchema.strict(),
      responses: {
        200: GetTypingFeedbackResponseSchema,
      },
      metadata: meta({
        rateLimit: "userTypingFeedback",
      }),
    },
  },
  {
